...
insert into TRAIN_DETAILS(TRAIN_NO,TRAIN_NAME,STATION_FROM,STATION_END,TOTAL_AVAILABLE_SEAT,COST_ADULT,COST_SENIOR,COST_CHILD) values(12707,'Andhra Pradesh Sampark Kranti','Pune','Kochi',5,1000,800,600);
